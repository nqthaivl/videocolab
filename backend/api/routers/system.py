...
PERSISTENT_KEYS = {
    ...
    "OPENAI_TRANSLATE_API_KEY", "OPENAI_TRANSLATE_MODEL", "OPENAI_TRANSLATE_BASE_URL",
    "GEMINI_TRANSLATE_API_KEY", "GEMINI_TRANSLATE_MODEL",
    "NINEROUTER_TRANSLATE_API_KEY", "NINEROUTER_TRANSLATE_MODEL", "NINEROUTER_TRANSLATE_BASE_URL",
